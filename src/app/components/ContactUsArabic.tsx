    ...
    return (
        <section dir="rtl" id="contact" className="bg-[#FDFBFA] py-20 font-poppins">
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                ...
                <p dir="rtl" className="text-[#070707] text-center font-poppins text-base sm:text-lg md:text-[20px] font-normal leading-[160%] tracking-[0.1px] max-w-3xl mx-auto mb-12">
                    دعونا نعمل معًا. سواء كنت تبحث عن التوسع في المملكة العربية السعودية أو  <br />
                    استكشاف آفاق استثمار جديدة، فإن <span className="font-bold">أدماس</span> هو شريكك الموثوق.
                </p>
