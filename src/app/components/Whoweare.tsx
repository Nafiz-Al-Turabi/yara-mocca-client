        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className=" text-[#070707] mb-8 font-poppins text-base sm:text-lg md:text-xl lg:text-[20px] font-normal leading-[160%] tracking-[0.1px]">
              ...
              from logistics and manpower services to industry-specific
              investments in:
            </p>
            ...
            <p className="text-[#070707] font-poppins text-base sm:text-lg md:text-xl lg:text-[20px] font-normal leading-[160%] tracking-[0.1px]">
              <strong>Admass</strong> holds a strong and respected reputation
              with major financial institutions, which has significantly
              contributed to our growth and credibility over the years. This
              reputation allows us to foster strategic partnerships and build
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="mb-6 text-[#070707] font-poppins text-base sm:text-lg md:text-xl lg:text-[20px] font-normal leading-[160%] tracking-[0.1px]">
              With a legacy of over three decades, <strong>Admass</strong> has
              developed deep relationships with international companies,
              government entities, and regional and international investors and
              partners.
            </p>
            <p className="text-[#070707] font-poppins text-base sm:text-lg md:text-xl lg:text-[20px] font-normal leading-[160%] tracking-[0.1px]">
              Today, we are evolving with a focus on sustainability, technology,
              and national development goals, aiming to become a publicly listed
              company and a leading force in shaping the new Saudi economy and
          ...
          <div className="relative w-full lg:w-1/2">
            ...
            <div className="absolute bottom-0 right-0 z-0">
              ...
              >
                ...
                <path
                  d="M0.0935059 0H142H0.0935059ZM154 183C154 194.046 145.046 203 134 203H20.0935C9.04781 203 0.0935059 194.046 0.0935059 183V179C0.0935059 179 3.67523 179 8.09351 179H130L154 183ZM0.0935059 191V0V191ZM134 0C145.046 0 154 8.9543 154 20V183C154 194.046 145.046 203 134 203L130 179V8C130 3.58172 130 0 130 0H134Z"
                  fill="#002B5B"
                  mask="url(#path-1-inside-1_5311_55)"
                />
              </svg>
            </div>
